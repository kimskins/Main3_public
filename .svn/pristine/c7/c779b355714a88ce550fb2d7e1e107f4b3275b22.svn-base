...
namespace Dukyou3
{
    public partial class Form_machin : Form
    {
        ...
        public Form_machin(string id, string sd, string md)
        {
            InitializeComponent();
            x_id = id;  //업체 고유번호
            f_id = sd;  //폼번호
        ...
        public Form_machin( string dd)
        {
            InitializeComponent();
            a_code = dd;  //대분류 코드번호
          }

        private void Form_machin_Load(object sender, EventArgs e)
        {
        ...
        private void button6_Click(object sender, EventArgs e)  //엑셀
        {
            try
            {
        ...
        private void button7_Click(object sender, EventArgs e)  //업체 기계등록
        {
            int insert = 0;
