...
namespace Dukyou3
{
    public partial class Form_501 : Form
    {
        ...
        private void Form_502_Load(object sender, EventArgs e)
        {
            ...
            fill_combo(cbMall_group, "mall종이그룹");
            fill_combo(cbMall_usage, "mall종이용도");
            ...
            cQuery = "select h.sangho as sangho, a.*, c.code, d.hang as bunryu, e.hang as pgroup, f.hang as pmake,g.hang as p_use,i.hang as mall_group,j.hang as mall_usage from " + DB_TableName_paper + " as a ";
            ...
            cQuery += " left outer join " + DB_TableName_hang + " as i on a.hang_mall_group_code = i.code1 and i.class = 'mall종이그룹' ";
            cQuery += " left outer join " + DB_TableName_hang + " as j on a.hang_mall_usage_code = j.code1 and j.class = 'mall종이용도' ";            
        ...
        private void fill_combo(ComboBox cb, string class_name)
        {
            string sql = "select code1,hang from hang_manage where class = '" + class_name + "'";
            ...
            while (myRead.Read())
            {
                dt.Rows.Add(new object[]{
                    myRead.GetString("code1"),
                    myRead.GetString("hang")});
                
            }

            cb.DataSource = dt;
            cb.DisplayMember = "hang";
            cb.ValueMember = "code1";
        ...
        private void make_m_dt(string cQuery)    //table(m_dt) 만들기+
        {
            ...
            {
                #region
                this.s_dt.Columns.Add("row_id", typeof(string)); //0
                this.s_dt.Columns.Add("check1", typeof(bool)); //1
                this.s_dt.Columns.Add("no", typeof(int));//2
                this.s_dt.Columns.Add("bunryu", typeof(string));//3
                this.s_dt.Columns.Add("pgroup", typeof(string));//4

                this.s_dt.Columns.Add("mall_group", typeof(string));//5
                this.s_dt.Columns.Add("mall_usage", typeof(string));//6
                this.s_dt.Columns.Add("mall_prn", typeof(string));//7

                this.s_dt.Columns.Add("favorite", typeof(bool));//5 ->8
                this.s_dt.Columns.Add("paper_weight", typeof(string));//9
                this.s_dt.Columns.Add("paper_name", typeof(string));//10
                this.s_dt.Columns.Add("paper_color", typeof(string));//11
                this.s_dt.Columns.Add("pmake", typeof(string));//12
                this.s_dt.Columns.Add("notice_price", typeof(string));//13
                this.s_dt.Columns.Add("paper_size_group", typeof(string));//14
                this.s_dt.Columns.Add("yunjeon_size_group", typeof(string));//15
                this.s_dt.Columns.Add("digital_size_group", typeof(string));//16
                this.s_dt.Columns.Add("paper_thick", typeof(string));//17
                this.s_dt.Columns.Add("make_company_code", typeof(string));//18
                this.s_dt.Columns.Add("paper_name_code", typeof(string));//19
                this.s_dt.Columns.Add("prove_paper_thick", typeof(bool));//20
                this.s_dt.Columns.Add("sock", typeof(string));//21
                this.s_dt.Columns.Add("ton_su", typeof(string));//22
                this.s_dt.Columns.Add("sunsu", typeof(string));//23
                this.s_dt.Columns.Add("hang_puse_group", typeof(string));//24
                this.s_dt.Columns.Add("supply_company_code", typeof(string));  //유통회사 코드모음 25
                this.s_dt.Columns.Add("code", typeof(string));                 //유통회사(1) web에서 사용 26
                this.s_dt.Columns.Add("sangho", typeof(string));//27
                this.s_dt.Columns.Add("macro", typeof(string));//28
                this.s_dt.Columns.Add("ton_price", typeof(string));//29

                this.s_dt.Columns.Add("hang_mall_group_code", typeof(string));//30
                this.s_dt.Columns.Add("hang_mall_usage_code", typeof(string));//31
                this.s_dt.Columns.Add("hang_mall_prn_code", typeof(string));//32
                #endregion
            }
            else
                s_dt.Rows.Clear();
            ...
            while (myRead.Read())
            {
                ...
                if (f_row_id != myRead["row_id"].ToString())
                {
                    ...
                    false,//1
                    i_no,//2
                    myRead["bunryu"].ToString(),//3
                    myRead["pgroup"].ToString(),//4

                    myRead["mall_group"].ToString(),
                    myRead["mall_usage"].ToString(),
                    myRead["hang_mall_prn_code"].ToString(),
                    ...
                    myRead["hang_mall_group_code"].ToString(),
                    myRead["hang_mall_usage_code"].ToString(),
                    myRead["hang_mall_prn_code"].ToString()
                    });
                    i_no++;
        ...
        private void make_grid1()  //datagrid
        {
            ...
            // 
            dataGrid1.Columns[4].HeaderCell = new MyHeader("종이그룹");
            ...
            dataGrid1.Columns[5].HeaderCell = new MyHeader("mall\n종이그룹");
            dataGrid1.Columns[5].Width = 70;
            dataGrid1.Columns[5].DataCell.View = cc.center_cell;
            dataGrid1.Columns[5].DataCell.Editor = cc.disable_cell;
            //
            dataGrid1.Columns[6].HeaderCell = new MyHeader("mall\n종이용도");
            dataGrid1.Columns[6].Width = 70;
            dataGrid1.Columns[6].DataCell.View = cc.center_cell;
            dataGrid1.Columns[6].DataCell.Editor = cc.disable_cell;
            //
            dataGrid1.Columns[7].HeaderCell = new MyHeader("mall\n인쇄방법");
            dataGrid1.Columns[7].Width = 70;
            dataGrid1.Columns[7].DataCell.View = cc.center_cell;
            dataGrid1.Columns[7].DataCell.Editor = cc.disable_cell;
            ...
            //
            dataGrid1.Columns[8].HeaderCell = new MyHeader1("검색순위");
            dataGrid1.Columns[8].Width = 80;
            // 
            dataGrid1.Columns[9].HeaderCell = new MyHeader("무게(g)");
            dataGrid1.Columns[9].Width = 60;
            dataGrid1.Columns[9].DataCell.View = cc.int_cellr;
            dataGrid1.Columns[9].DataCell.AddController(ValueChangEvent1);
            // 
            dataGrid1.Columns[10].HeaderCell = new MyHeader("종 이 명");
            dataGrid1.Columns[10].Width = 80;
            dataGrid1.Columns[10].DataCell.View = cc.center_cellr;
            dataGrid1.Columns[10].DataCell.AddController(ValueChangEvent1);
            // 
            dataGrid1.Columns[11].HeaderCell = new MyHeader("색  상");
            dataGrid1.Columns[11].Width = 90;
            dataGrid1.Columns[11].DataCell.View = cc.center_cellr;
            dataGrid1.Columns[11].DataCell.AddController(ValueChangEvent1);
            // 
            dataGrid1.Columns[12].HeaderCell = new MyHeader("제지사");
            dataGrid1.Columns[12].Width = 90;
            dataGrid1.Columns[12].DataCell.View = cc.center_cell;
            dataGrid1.Columns[12].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[13].HeaderCell = new MyHeader("공시단가");
            dataGrid1.Columns[13].Width = 80;
            dataGrid1.Columns[13].DataCell.View = cc.int_cellr;
            dataGrid1.Columns[13].DataCell.AddController(ValueChangEvent1);
            // 
            dataGrid1.Columns[14].HeaderCell = new MyHeader("매　엽" + "\r\n" + "사이즈그룹");
            dataGrid1.Columns[14].Width = 140;
            dataGrid1.Columns[14].DataCell.View = cc.left_cell;
            dataGrid1.Columns[14].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[15].HeaderCell = new MyHeader("윤　전" + "\r\n" + "사이즈그룹");
            dataGrid1.Columns[15].Width = 140;
            dataGrid1.Columns[15].DataCell.View = cc.left_cell;
            dataGrid1.Columns[15].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[16].HeaderCell = new MyHeader("디지털윤전" + "\r\n" + "사이즈그룹");
            dataGrid1.Columns[16].Width = 140;
            dataGrid1.Columns[16].DataCell.View = cc.left_cell;
            dataGrid1.Columns[16].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[17].HeaderCell = new MyHeader("두께");
            dataGrid1.Columns[17].Width = 80;
            dataGrid1.Columns[17].DataCell.View = cc.int_cellr;
            dataGrid1.Columns[17].DataCell.AddController(ValueChangEvent1);
            // 
            dataGrid1.Columns[18].HeaderCell = new MyHeader("제작사" + "\r\n" + "코드");
            dataGrid1.Columns[18].Width = 80;
            dataGrid1.Columns[18].DataCell.View = cc.center_cell;
            dataGrid1.Columns[18].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[19].HeaderCell = new MyHeader("종이명" + "\r\n" + "코드");
            dataGrid1.Columns[19].Width = 80;
            dataGrid1.Columns[19].DataCell.View = cc.center_cell;
            dataGrid1.Columns[19].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[20].HeaderCell = new MyHeader("제공");
            dataGrid1.Columns[20].Width = 60;
            dataGrid1.Columns[20].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[21].HeaderCell = new MyHeader("속(장)");
            dataGrid1.Columns[21].Width = 60;
            dataGrid1.Columns[21].DataCell.View = cc.center_cellr;
            dataGrid1.Columns[21].DataCell.AddController(ValueChangEvent1);
            // 
            dataGrid1.Columns[22].HeaderCell = new MyHeader("톤수");
            dataGrid1.Columns[22].Width = 70;
            dataGrid1.Columns[22].DataCell.View = cc.int_cell;
            dataGrid1.Columns[22].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[23].HeaderCell = new MyHeader("선수");
            ...
            // 
            dataGrid1.Columns[24].HeaderCell = new MyHeader("용도");
            dataGrid1.Columns[24].Width = 80;
            dataGrid1.Columns[24].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[25].HeaderCell = new MyHeader("유통업체" + "\r\n" + "코드");
            dataGrid1.Columns[25].Width = 160;
            dataGrid1.Columns[25].DataCell.View = cc.center_cell;
            dataGrid1.Columns[25].DataCell.Editor = cc.disable_cell;
            //
            dataGrid1.Columns[26].HeaderCell = new MyHeader("지업사" + "\r\n" + "코드");
            dataGrid1.Columns[26].Width = 80;
            dataGrid1.Columns[26].DataCell.View = cc.center_cell;
            dataGrid1.Columns[26].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[27].HeaderCell = new MyHeader("관리업체");
            dataGrid1.Columns[27].Width = 120;
            dataGrid1.Columns[27].DataCell.View = cc.center_cell;
            dataGrid1.Columns[27].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[28].HeaderCell = new MyHeader("macro");
            dataGrid1.Columns[28].Width = 80;
            dataGrid1.Columns[28].DataCell.View = cc.center_cell;
            dataGrid1.Columns[28].DataCell.Editor = cc.disable_cell;
            // 
            dataGrid1.Columns[29].HeaderCell = new MyHeader("톤당단가");
            dataGrid1.Columns[29].Width = 90;
            dataGrid1.Columns[29].DataCell.View = cc.int_cellr;
            dataGrid1.Columns[29].DataCell.AddController(ValueChangEvent1);
        ...
        private void bPackMody_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("수정하시겠습니까?", "수정", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
            {
                ...
                if (cbMall_group.SelectedIndex != -1)
                    set_itemp += ", hang_mall_group_code = '" + cbMall_group.SelectedValue + "'";

                if (cbMall_usage.SelectedIndex != -1)
                    set_itemp += ", hang_mall_usage_code = '" + cbMall_usage.SelectedValue + "'";

                if (tbMall_prn.Text.Trim() != "")
                    set_itemp += ", hang_mall_prn_code = '" + tbMall_prn.Text.Trim() + "'";
        ...
        private void bMClear_Click(object sender, EventArgs e)
        {
            ...
            tbTonsu.Text = "";
            tbNoticePrice.Text = "";
            cbMall_group.SelectedIndex = -1;
            cbMall_usage.SelectedIndex = -1;
            tbMall_prn.Text = "";
        ...
        private void ReadExcel(string strFilePath)
        {
            ...
            string cSql = "insert into C_paper(hang_class_code,hang_pgroup_code,paper_weight,paper_name,paper_color,hang_pmake_code,notice_price,paper_thick,sock,ton_su,ton_price,paper_size_group,yunjeon_size_group,digital_size_group) values"; //인서트 쿼리          
            string uSql = "";
            string sql = "";
            sql = "select code1,hang FROM hang_manage WHERE class = '제지사';";
            cmd = new MySqlCommand(sql, DBConn);
            rdr = cmd.ExecuteReader();
            DataTable pmake_dt = new DataTable();
            pmake_dt.Columns.Add("code1");
            pmake_dt.Columns.Add("hang");
            while(rdr.Read())
            {
                pmake_dt.Rows.Add(new object[]
                {
                    rdr["code1"].ToString(),
                    rdr["hang"].ToString()
                });
            ...
            sql = "select code1,hang FROM hang_manage WHERE class = '종이그룹';";
            cmd = new MySqlCommand(sql, DBConn);
            rdr = cmd.ExecuteReader();
            DataTable pgroup_dt = new DataTable();
            pgroup_dt.Columns.Add("code1");
            pgroup_dt.Columns.Add("hang");
            while (rdr.Read())
            {
                pgroup_dt.Rows.Add(new object[]
                {
                    rdr["code1"].ToString(),
                    rdr["hang"].ToString()
                });
            ...
            sql = "select code1,hang FROM hang_manage WHERE class = '%분류';";
            cmd = new MySqlCommand(sql, DBConn);
            rdr = cmd.ExecuteReader();
            DataTable percent_group_dt = new DataTable();
            percent_group_dt.Columns.Add("code1");
            percent_group_dt.Columns.Add("hang");
            while (rdr.Read())
            {
                percent_group_dt.Rows.Add(new object[]
                {
                    rdr["code1"].ToString(),
                    rdr["hang"].ToString()
                });
            ...
            for (int i = 2; i <= data.GetLength(0); i++)
            {
                ...
                pgroup = "";
                pmake = "";                
                paper_weight = (data[i,3] == null  || data[i,3].ToString() == "" ) ? "0":data[i,3].ToString();                 
                notice_price = (data[i, 7] == null || data[i, 7].ToString() == "") ? "0" : data[i, 7].ToString();
                paper_thick = (data[i, 8] == null || data[i, 8].ToString() == "") ? "0" : data[i, 8].ToString();
                sock = (data[i, 9] == null || data[i, 9].ToString() == "") ? "0" : data[i, 9].ToString();
                ton_su = (data[i, 10] == null || data[i, 10].ToString() == "") ? "0" : data[i, 10].ToString();
                ton_price = (data[i, 11] == null || data[i, 11].ToString() == "") ? "0" : data[i, 11].ToString(); ;

                if (data[i, 1] != null)
                {
                    tempdr = percent_group_dt.Select("hang = '" + data[i, 1].ToString() + "'");
                    if (tempdr.Length != 0)
                    {
                        percent_group = tempdr[0]["code1"].ToString();
                    }
                }

                if (data[i, 2] != null)
                {
                    tempdr = pgroup_dt.Select("hang = '" + data[i, 2].ToString() + "'");
                    if (tempdr.Length != 0)
                    {
                        pgroup = tempdr[0]["code1"].ToString();
                    }
                }
               
                if(data[i,6] != null)
                {
                    tempdr = pmake_dt.Select("hang = '" + data[i, 6].ToString() + "'");
                    if (tempdr.Length != 0)
                    {
                        pmake = tempdr[0]["code1"].ToString();
                    }
                }



                sql = "select row_id from C_paper where hang_class_code = '"+percent_group+"' and paper_weight = '" + paper_weight + "' and paper_name = '" + data[i, 4] + "' and paper_color = '" + data[i, 5] + "' and hang_pmake_code = '" + pmake + "';";
                cmd = new MySqlCommand(sql, DBConn);
                rdr = cmd.ExecuteReader();
                row_id = "";
                if(rdr.Read())
                {
                    row_id = rdr[0].ToString();
                }
                rdr.Close();
                if (row_id != "") //중복되는 행이 있으면
                {                   
                    temp = "";
                    if (notice_price != "0") temp += ",notice_price = '"+notice_price+"'";
                    if (paper_thick != "0") temp += ",paper_thick = '" + paper_thick + "'";
                    if (sock != "0") temp += ",sock = '" + sock + "'";
                    if (ton_price != "0") temp += ",ton_price = '" + ton_price + "'";
                    if(temp != "")
                    {
                        uSql += "update C_paper set " + temp.Substring(1) + " where row_id = '" + row_id + "';";
                    }                   
                }
                else
                {
                    cSql += "('"+percent_group+"','" + pgroup + "','" + paper_weight + "','" + data[i, 4] + "','" +
                    data[i, 5] + "','" + pmake + "','" + notice_price +
                    "','" + paper_thick + "','" + sock + "','" + ton_su + "','" + ton_price + "','" + data[i, 12] + "','" + data[i, 13] + "','" + data[i, 14] + "'),";
                }
            }
            ...
            {
                cmd = new MySqlCommand(cSql, DBConn);
                cmd.ExecuteNonQuery();
            }
            if (uSql != "")
            {
                cmd = new MySqlCommand(uSql, DBConn);
                cmd.ExecuteNonQuery();
            }
        ...
        private void button6_Click(object sender, EventArgs e) // 업로드양식다운로드
        {
            SaveFileDialog sfd = new SaveFileDialog();
            sfd.DefaultExt = "xlsx";
            sfd.FileName = "main3 지류 업로드양식";
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                string path = sfd.FileName;               
                    ...
                    {
                        client.Credentials = new NetworkCredential("help_file", "emotion$#@!");
                        client.Encoding = Encoding.Default;
                        //client.DownloadFile("ftp://" + ftpServerIP + "/" + ftp_dir + "/" + ftp_file_name, down_file_path);
                        Uri uri = new Uri("ftp://peras1.synology.me:21212/home/20210303/144632_1.xlsx");
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            string sql = "select code1,hang from hang_manage where class = 'mall인쇄방법' order by code1";
            var DBConn = new MySqlConnection(Config.DB_con1);
            DBConn.Open();
            var cmd = new MySqlCommand(sql, DBConn);
            var myRead = cmd.ExecuteReader();
            ...
            DBConn.Close();
            Form_501e frm = new Form_501e(dt,button7);
            frm.ShowDialog();
            if(frm.selected)
            {
                tbMall_prn.Text = frm.selected_string;
            }                     
        }
        /*
private void button5_Click(object sender, EventArgs e)
