...
namespace Dukyou3
{
    public partial class Form_2123 : Form
    {
        ...
        private void Form_2111_Load(object sender, EventArgs e)
        {
        ...
        private void GridView(string Query)
        {
            ...
            grid1[1, 7] = new MyHeader1("4도/ 3도");
            grid1[1, 8] = new MyHeader1("2도비율");
            grid1[1, 9] = new MyHeader1("1도비율");
            grid1[1, 10] = new MyHeader1("0도비율");

            grid1[0, 11] = new MyHeader1("인쇄에 따른 여분 증감");
            grid1[0, 11].ColumnSpan = 3;
            grid1[1, 11] = new MyHeader1("감리통수");
            grid1[1, 12] = new MyHeader1("CIP 수량");
            grid1[1, 13] = new MyHeader1("고급인쇄");
            ...
            while (myRead.Read())
            {
                ...
                grid1[m, 7] = new SourceGrid.Cells.Cell(myRead["dosu_4"], typeof(decimal));
                grid1[m, 7].View = cc.int_cellr;

                grid1[m, 8] = new SourceGrid.Cells.Cell(myRead["dosu_2"], typeof(decimal));
                grid1[m, 8].View = cc.int_cellr;

                grid1[m, 9] = new SourceGrid.Cells.Cell(myRead["dosu_1"], typeof(decimal));
                grid1[m, 9].View = cc.int_cellr;

                grid1[m, 10] = new SourceGrid.Cells.Cell(myRead["dosu_0"], typeof(decimal));
                grid1[m, 10].View = cc.int_cellr;

                grid1[m, 11] = new SourceGrid.Cells.Cell(myRead["gamri_tong"], typeof(int));
                grid1[m, 11].View = cc.int_cellr;
                grid1[m, 11].Editor = cc.int_editor;

                grid1[m, 12] = new SourceGrid.Cells.Cell(myRead["cip_su"], typeof(int));
                grid1[m, 12].View = cc.int_cellr;
                grid1[m, 12].Editor = cc.int_editor;

                grid1[m, 13] = new SourceGrid.Cells.Cell(myRead["hi_quality"], typeof(int));
        ...
        {
            string Query = "insert into " + DB_TableName_extra + " (volume_range_min) values('0')";
        ...
        private void GridNewLine(string row_no)
        {
            ...
            grid1[Rows, 11] = new SourceGrid.Cells.Cell(0, typeof(int));
            grid1[Rows, 11].View = cc.int_cellr;
            grid1[Rows, 11].Editor = cc.int_editor;

            grid1[Rows, 12] = new SourceGrid.Cells.Cell(0, typeof(int));
            grid1[Rows, 12].View = cc.int_cellr;
            grid1[Rows, 12].Editor = cc.int_editor;
        ...
        {
            string Query = "select * from " + DB_TableName_extra + " order by row_id";
            GridView(Query);  
        }
    }
}
