...
viewer.Image = Properties.Resources.중철홀더;
...
namespace Dukyou
{
    ...
    public partial class ImageViewer : ScrollableControl
    {
            ...
            : base()
        {
            ...
            this.InterpolationMode = InterpolationMode.High;
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ImageViewer"/> is grabbed.
        /// </summary>
