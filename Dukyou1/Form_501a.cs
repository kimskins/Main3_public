...
namespace Dukyou3
{
    public partial class Form_501a : Form
    {
        ...
        SourceGridControl GridHandle_mall_group = new SourceGridControl();
        SourceGridControl GridHandle_mall_usage = new SourceGridControl();
        SourceGridControl GridHandle_mall_prn = new SourceGridControl();
        ...
        private void Form_502a_Load(object sender, EventArgs e)
        {
            ...
            GridHandle_mall_group.SourceGrideInit(grid_mall_group, Config.DB_con1);
            GridHandle_mall_usage.SourceGrideInit(grid_mall_usage, Config.DB_con1);
            GridHandle_mall_prn.SourceGrideInit(grid_mall_prn, Config.DB_con1);
        }
        ...
        private void Data_Load()
        {
            ...
            if (NewItem)
            {
                ...
                cQuery = "select * from " + DB_TableName_hang + " where class = 'mall종이그룹' order by no";
                Grid_group_View(grid_mall_group, cQuery, "A0", 1);

                cQuery = "select * from " + DB_TableName_hang + " where class = 'mall종이용도' order by no";
                Grid_group_View(grid_mall_usage, cQuery, "A0", 1);

                cQuery = "select * from " + DB_TableName_hang + " where class = 'mall인쇄방법' order by no";
                Grid_group_View(grid_mall_prn, cQuery, "A0", 1);
            ...
            else
            {
                ...
                cQuery = "select * from " + DB_TableName_hang + " where class = 'mall종이그룹' order by no";
                Grid_group_View(grid_mall_group, cQuery, s_dt.Rows[rpos]["hang_mall_group_code"].ToString(), 1);

                cQuery = "select * from " + DB_TableName_hang + " where class = 'mall종이용도' order by no";
                Grid_group_View(grid_mall_usage, cQuery, s_dt.Rows[rpos]["hang_mall_usage_code"].ToString(), 1);

                cQuery = "select * from " + DB_TableName_hang + " where class = 'mall인쇄방법' order by no";
                Grid_group_View(grid_mall_prn, cQuery, s_dt.Rows[rpos]["hang_mall_prn_code"].ToString(), 2);
            }
        }
        ...
        private void Grid_mall_group_View(SourceGrid.Grid grid, string cQuery, string chk_item_group, int code_len)
        {
            cell_d cc = new cell_d();
            // 
            grid.Rows.Clear();
        ...
        private void Grid_mall_usage_View(SourceGrid.Grid grid, string cQuery, string chk_item_group, int code_len)
        {
            cell_d cc = new cell_d();
            // 
            grid.Rows.Clear();
        ...
        private void Grid_mall_prn_View(SourceGrid.Grid grid, string cQuery, string chk_item_group, int code_len)
        {
            cell_d cc = new cell_d();
            // 
            grid.Rows.Clear();
        ...
        private void bModi_Click(object sender, EventArgs e)
        {
            ...
            string mall_group = "";
            Get_item_package(ref mall_group, grid_mall_group);

            string mall_usage = "";
            Get_item_package(ref mall_usage, grid_mall_usage);

            string mall_prn = "";
            Get_item_package(ref mall_prn, grid_mall_prn);
            ...
            cQuery += ", hang_mall_group_code = '" + mall_group + "', hang_mall_usage_code = '" + mall_usage + "', hang_mall_prn_code = '" + mall_prn + "'";
        ...
        private void bAdd_Click(object sender, EventArgs e)
        {
            ...
            cQuery += "sock, sunsu, hang_puse_group, paper_weight, paper_name, paper_color, paper_thick, notice_price, ton_su, yunjeon_size_group, supply_company_code,hang_mall_group_code,hang_mall_usage_code,hang_mall_prn_code) values(";
            cQuery += "'" + bunryu_code + "', '" + pgroup_code + "', '" + pmake_code + "', '" + sgroup + "', " + Jang + ", " + Sun + ", '" + puse + "', '" + weight + "'";
            cQuery += ", '" + pname + "', '" + pcolor + "', '" + pthick + "', '" + notice_price + "','0', '" + ygroup + "', '" + jiup_code + "', '"+mall_group+"', '"+mall_usage+"', '"+mall_prn+"')";
        ...
        private void grid_mall_group_Click(object sender, EventArgs e)
        {
            GridHandle_mall_group.OnlyOneChk(1, grid_mall_group.Selection.ActivePosition.Row, 1);
        }

        private void grid_mall_usage_Click(object sender, EventArgs e)
        {
            GridHandle_mall_usage.OnlyOneChk(1, grid_mall_usage.Selection.ActivePosition.Row, 1);
        }

        private void grid_mall_group_MouseClick(object sender, MouseEventArgs e)
        {
            
        }

        private void grid_mall_usage_MouseClick(object sender, MouseEventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cQuery = "select concat(paper_alias,'(',size_alias,')',grain) as hang, base_paper_code as code1, row_id, grain from " + DB_TalbeName_scode;
            cQuery += $" where prn_guboon='매엽'{width}{height} order by grain desc, sort_no";
            Grid_sizegroup_View(grid_sgroup, cQuery, s_dt.Rows[rpos]["paper_size_group"].ToString(), 1);
        }
